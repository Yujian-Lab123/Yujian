    ...
    <main className={`relative min-h-[100dvh] overflow-hidden bg-[#f4f5f7] ink-texture-blue ${styles.page}`}>
      ...
      <section className="relative z-10 mx-auto max-w-5xl px-4 pb-24 sm:px-6">
        ...
        <div className="flex flex-wrap items-end justify-between gap-6">
          ...
          <div className="fade-up-1 flex w-full items-center justify-center gap-5 font-display sm:w-auto sm:justify-start sm:gap-6">
        ...
        {loaded && items.length === 0 && (
          <div className="card-blue mt-12 p-8 text-center leading-7 text-sumi-500 sm:p-14">
        ...
        <div className="mt-10 space-y-5">
          {items.map((it) => (
            <div key={it.id} className="card-blue flex flex-col gap-5 p-4 sm:p-6 md:flex-row md:items-center">
                ...
                <div className="min-w-0">
                  ...
                  {it.type === 'mutual' ? (
                    <>
                      ...
                      <p className="mt-0.5 text-sm leading-6 text-sumi-600 sm:truncate">{it.question || '从彼此的内容开始。'}</p>
              ...
              <div className="flex shrink-0 items-center justify-between gap-5 sm:justify-end md:flex-col md:items-end md:gap-2">
