...
export default function Landing() {
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#f4f5f7] ink-texture-blue">
      ...
      <section className="relative z-10 mx-auto max-w-4xl px-6 pt-14 text-center md:pt-20">
        <h1 className="brush-in font-display text-5xl font-bold text-ink-900 md:text-6xl">
          发现一个值得聊一句的人
        </h1>
        <svg className="mx-auto -mt-1 w-64 opacity-60" viewBox="0 0 300 20" fill="none">
          <path d="M10 12 Q150 2 290 10" stroke="#0f4ce8" strokeWidth="2" strokeLinecap="round" opacity="0.5" />
        </svg>

        <div className="fade-up-1 mt-8 space-y-2 text-lg text-sumi-600">
      ...
      <section className="relative z-10 mx-auto mt-16 max-w-6xl px-6 pb-20">
        <div className="card-blue grid gap-10 p-8 md:grid-cols-2 md:p-12">
          <div className="fade-up-2">
            <div className="mb-6 flex h-14 w-14 items-center justify-center rounded-full bg-ink-100 text-2xl">🖋</div>
            <h2 className="font-display text-3xl leading-snug text-ink-900">
              你不需要<br />重新写一份自我介绍，
            </h2>
            <h2 className="mt-2 font-display text-3xl leading-snug text-ink-600">
              你写过的东西，<br />本身就是。
            </h2>
          ...
          <div className="fade-up-3 rounded-xl border border-ink-100 bg-white/70 p-6">
